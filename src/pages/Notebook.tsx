...
const Notebook: React.FC = () => {
  const weekEntries: WeekEntry[] = [
    ...
    },
    {
      ...
      description: 'Arquitectura de aplicaciones web, servidores web, funcionamiento del server side, lenguaje y framework backend.',
      topics: ['Arquitectura Web', 'Servidores Web', 'PHP', 'JSP', 'Despliegue Backend'],
      path: '/notebook/week-9',
    },    
    {
      id: 'week10',
      week: 10,
      title: 'Lenguaje Python',
      description: 'Introducción a Python, sintaxis básica, estructuras de datos, POO y desarrollo de aplicaciones.',
      topics: ['Sintaxis Python', 'Estructuras de Datos', 'POO', 'Excepciones', 'Módulos'],
      path: '/notebook/week-10',
    },
    {
      id: 'week11',
      week: 11,
      title: 'Introducción a Django',
      description: 'Framework web de Python, patrón MTV, gestión de URLs, vistas, plantillas y modelos de datos.',
      topics: ['Patrón MTV', 'URLs y Vistas', 'Plantillas Django', 'Modelos y ORM', 'Panel Admin'],
      path: '/notebook/week-11',
    },    
    {
      id: 'week12',
      week: 12,
      title: 'Formularios, Admin y Middleware',
      description: 'Gestión avanzada de formularios, personalización del panel admin, middleware y sistemas de autenticación.',
      topics: ['Formularios Django', 'Validación Avanzada', 'Admin Personalizado', 'Middleware', 'Autenticación'],
      path: '/notebook/week-12',
    },
    {
      id: 'week13',
      week: 13,
      title: 'Diseño de APIs RESTful',
      description: 'Django REST Framework, serialización, HATEOAS, filtrado, paginación y seguridad en APIs.',
      topics: ['REST & HATEOAS', 'Serialización', 'ViewSets', 'Filtrado/Paginación', 'CORS & Seguridad'],
      path: '/notebook/week-13',
    },    
    {
      id: 'week14',
      week: 14,
      title: 'Microservicios en Django',
      description: 'Arquitectura de microservicios, comunicación entre servicios, Docker, Kubernetes y monitoreo distribuido.',
      topics: ['Arquitectura Microservicios', 'Comunicación Servicios', 'Docker/Kubernetes', 'Monitoreo', 'Escalado'],
      path: '/notebook/week-14',
    },    
  ];
